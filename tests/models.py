...
class GrainTest(models.Model):
    ...
    bad_grain_count = models.CharField(max_length=255, null=False, default='42%')
    good_grain_count = models.CharField(max_length=255, null=False, default='58%')
    total_grain_count = models.IntegerField(default=randint(1,70))
